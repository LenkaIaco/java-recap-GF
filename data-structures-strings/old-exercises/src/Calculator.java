...
public class Calculator {
    ...
    public static int calculator() {
        ...
        System.out.println("Enter operator and two operands separated by spaces, e.g.  \"+ 3 3\" (the result will be 6)");
        ...
        int operand1 = Integer.valueOf(splits[1]);
        int operand2 = Integer.valueOf(splits[2]);
